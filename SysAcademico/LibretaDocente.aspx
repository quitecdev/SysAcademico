<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LibretaDocente.aspx.cs" Inherits="SysAcademico.LibretaDocente" %>
...
<head>
    ...
    <style>
        .table-collapse .table-collapse-thead {
            background: #8b1716;
        }

            .table-collapse .table-collapse-thead th {
                color: #fff;
                padding: 20px !important;
            }

        .table-collapse .table-collapse-tbody > tr > td {
            padding: 20px !important;
            /*font-weight: 600;*/
            cursor: pointer;
        }
            ...
            function endReq(sender, args) {
                ...
                $(document).ready(function () {
                    $("table input").change(function () {
                        var ID_ESTUDIANTE_NOTA = $(this).data('nota');
                        ...
                        $.ajax({
                            ...
                            url: "LibretaDocente.aspx/ActualizarNota",
                            data: '{ID_ESTUDIANTE_NOTA:"' + ID_ESTUDIANTE_NOTA +'",VALOR_NOTA:"' + VALOR_NOTA + '"}',
