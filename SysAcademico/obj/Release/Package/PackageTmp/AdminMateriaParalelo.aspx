<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMateriaParalelo.aspx.cs" Inherits="SysAcademico.AdminMateriaParalelo" %>
...
<body onload="pageLoad();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">MATERIAL/PARALELO</h4>
            </div>
        </div>
                ...
                <div class="card-box table-responsive">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="m-t-25"></div>
                            <asp:GridView ID="GridParalelo" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjectDataSource1" OnRowUpdating="GridParalelo_RowUpdating">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_PARALELO_MATERIA" runat="server" Text='<%# Bind("ID_PARALELO_MATERIA") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="MAX. ALUMNOS">
                                        <ItemTemplate>
                                            <asp:Label ID="MAX_ASIGANDO" runat="server" Text='<%# Bind("MAX_ASIGANDO") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_asignado" Text='<%# Bind("MAX_ASIGANDO") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerMateriaParalelo" TypeName="SysAcademico.App_Code.AdminMateriaParalelo" OnUpdating="ObjectDataSource1_Updating" UpdateMethod="ActualizarMateria">
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="0" Name="ID_MATERIA" SessionField="ID_MATERIA" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="ID_PARALELO_MATERIA" Type="String" />
                                    <asp:Parameter Name="MAX_ASIGANDO" Type="String" />
                                </UpdateParameters>
                                        ...
                                        <ContentTemplate>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Carrea:</label>
                                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_carreraAñadir" AutoPostBack="True" OnSelectedIndexChanged="cmb_carreraAñadir_SelectedIndexChanged" required></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_paralelo" required></asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Max. Alumnos:</label>
                                                        <asp:TextBox runat="server" ID="txt_cantidad" CssClass="form-control" TextMode="Number" required></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
