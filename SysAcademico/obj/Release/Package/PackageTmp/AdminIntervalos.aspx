<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminIntervalos.aspx.cs" Inherits="SysAcademico.AdminIntervalos" %>
...
<body onload="pageLoad();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">INTERVALO</h4>
            </div>
        </div>
                        ...
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tipo Carrera:</label>
                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_tipoHorario" AutoPostBack="True" OnSelectedIndexChanged="cmb_tipoHorario_SelectedIndexChanged1"></asp:DropDownList>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="m-t-25"></div>
                            <asp:GridView ID="GridIntervalo" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjIntervalo" OnRowUpdating="GridIntervalo_RowUpdating">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_INTERVALO" runat="server" Text='<%# Bind("ID_INTERVALO") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="DESCRIPCION">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_descripcion" Text='<%# Bind("DESCRIPCION_INTERVALO") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:ObjectDataSource runat="server" ID="ObjIntervalo" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerIntervalo" TypeName="SysAcademico.App_Code.AdminIntervalo" OnUpdating="ObjIntervalo_Updating" UpdateMethod="ActualizarIntervalo">
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="0" Name="ID_SEDE" SessionField="ID_SEDE" Type="String" />
                                    <asp:SessionParameter DefaultValue="0" Name="ID_TIPO_INTERVALO" SessionField="ID_TIPO_INTERVALO" Type="String" />
                                    <asp:SessionParameter DefaultValue="0" Name="ID_HORARIO_TIPO" SessionField="ID_HORARIO_TIPO" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="ID_INTERVALO" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_INTERVALO" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_UNIVERSIDAD" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_HORARIO_TIPO" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_TIPO_INVERTALO" Type="String" />
                                </UpdateParameters>
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Tipo Carrera:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_tipoHorarioAñadir" required></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Modalidad:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_tipoIntervaloAñadir" required></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
