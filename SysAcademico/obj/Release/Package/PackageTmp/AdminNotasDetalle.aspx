<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminNotasDetalle.aspx.cs" Inherits="SysAcademico.AdminNotasDetalle" %>
...
<body onload="pageLoad();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">ADMINISTRAR NOTAS DETALLE</h4>
            </div>
        </div>
                ...
                <div class="card-box table-responsive">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GridNotasDetalle" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjIntervalo" OnRowUpdating="GridNotasDetalle_RowUpdating" OnRowCommand="GridNotasDetalle_RowCommand" OnRowDataBound="GridNotasDetalle_RowDataBound" ShowFooter="True">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_NOTA_DETALLE" runat="server" Text='<%# Bind("ID_NOTA_DETALLE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="DESCRIPCION">
                                        <ItemTemplate>
                                            <asp:Label ID="DESCRIPCION_NOTA_DETALLE" runat="server" Text='<%# Bind("DESCRIPCION_NOTA_DETALLE") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_descripcion" Text='<%# Bind("DESCRIPCION_NOTA_DETALLE") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="PORCENTAJE (%)">
                                        <ItemTemplate>
                                            <asp:Label ID="PORCENTAJE" runat="server" Text='<%# Bind("PORCENTAJE") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Eliminar">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnk_eliminar" CommandName="Obtener" CommandArgument='<%# Bind("ID_NOTA_DETALLE") %>' runat="server">
                            ...
                            <asp:ObjectDataSource runat="server" ID="ObjIntervalo" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerIntervalo" TypeName="SysAcademico.App_Code.AdminNotasDetalle" OnUpdating="ObjIntervalo_Updating" UpdateMethod="ActualizarIntervalo">
                                <SelectParameters>
                                    <asp:ControlParameter ControlID="cmb_nota" DefaultValue="0" Name="ID_NOTA" PropertyName="SelectedValue" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="ID_NOTA_DETALLE" Type="String" />
                                    <asp:Parameter Name="ID_NOTA" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_NOTA_DETALLE" Type="String" />
                                    <asp:Parameter Name="PORCENTAJE" Type="String" />
                                </UpdateParameters>
                            </asp:ObjectDataSource>
                            <asp:HiddenField Value="" ID="hd_index" runat="server" />
                            <asp:HiddenField Value="" ID="id_notaDetalle" runat="server" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
