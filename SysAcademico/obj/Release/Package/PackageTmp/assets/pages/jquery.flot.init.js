...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var datas = [20, 30, 15];
		var colors = ['#da5461', "#8b1716","#fe8995"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation
		var plot = this.createRealTimeGraph('#flotRealTime', this.randomData(), ['#8b1716']);
		plot.draw();
		var $this = this;
		function updatePlot() {
		...
		var donutcolors = ['#8b1716', '#e57373', "#ef9a9a", "#ffcdd2"];
