<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminHorario.aspx.cs" Inherits="SysAcademico.AdminHorario" %>
                ...
                <div class="card-box table-responsive">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_intervaloDetalle" AutoPostBack="true" OnSelectedIndexChanged="cmb_intervaloDetalle_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="m-t-25"></div>
                            <asp:GridView ID="GridIntervalo" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjectDataSource1">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_HORARIO" runat="server" Text='<%# Bind("ID_HORARIO") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="DÍA ASIGANADO">
                                        <ItemTemplate>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerIntervalo" TypeName="SysAcademico.App_Code.AdminHorario">
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="0" Name="ID_INTERVALO_DETALLE" SessionField="ID_INTERVALO_DETALLE" Type="String" />
                                </SelectParameters>
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Intervalo:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_intervaloAñadir" AutoPostBack="true" OnSelectedIndexChanged="cmb_intervaloAñadir_SelectedIndexChanged" required></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_Día" required></asp:DropDownList>
                                        </div>
                                    </div>
