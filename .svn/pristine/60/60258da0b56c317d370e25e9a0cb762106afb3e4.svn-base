<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminNotas.aspx.cs" Inherits="SysAcademico.AdminNotas" %>
...
<body onload="pageLoad();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">ADMINISTRAR NOTAS</h4>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="card-box table-responsive">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="m-t-25"></div>
                            <asp:GridView ID="GridParalelo" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjectDataSource1" OnRowUpdating="GridParalelo_RowUpdating" OnRowCommand="GridParalelo_RowCommand" OnRowDataBound="GridParalelo_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_NOTA" runat="server" Text='<%# Bind("ID_NOTA") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="DESCRIPCION NOTA">
                                        <ItemTemplate>
                                            <asp:Label ID="DESCRIPCION_NOTA" runat="server" Text='<%# Bind("DESCRIPCION_NOTA") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_descripcion" Text='<%# Bind("DESCRIPCION_NOTA") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Eliminar">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnk_eliminar" CommandName="ObtenerDocente" CommandArgument='<%# Bind("ID_NOTA") %>' runat="server">
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerDetalle" TypeName="SysAcademico.App_Code.AdminNotas" OnUpdating="ObjectDataSource1_Updating" UpdateMethod="ActualizarIntervalo">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="-1" Name="ID_NOTA" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="ID_NOTA" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_NOTA" Type="String" />
                                </UpdateParameters>
                            </asp:ObjectDataSource>
                            <asp:HiddenField Value="" ID="hd_index" runat="server" />
                            <asp:HiddenField Value="" ID="id_nota" runat="server" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    ...
                    <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h4 class="modal-title">Datos Notas</h4>
                                </div>
                                <div class="modal-body">
                                    <asp:UpdatePanel runat="server" ID="up2">
                                        <ContentTemplate>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="field-1" class="control-label">Descripción Nota</label>
                                                        <asp:TextBox runat="server" ID="txt_nota" CssClass="form-control" required></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
