<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminCarreras.aspx.cs" Inherits="SysAcademico.AdminCarreras" %>
                ...
                <div class="card-box table-responsive">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="m-t-25"></div>
                            <asp:GridView ID="GridCarrera" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjectDataSource1" OnRowDeleting="GridCarrera_RowDeleting" OnRowEditing="GridCarrera_RowEditing" OnRowUpdating="GridCarrera_RowUpdating" OnRowDataBound="GridCarrera_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <asp:Label ID="ID_CARRERA" runat="server" Text='<%# Bind("ID_CARRERA") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="DESCRIPCION">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_descripcion" Text='<%# Bind("DESCRIPCION_CARRERA") %>' runat="server" CssClass="form-control" required></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="TALLER">
                                        <ItemTemplate>
                                            <asp:Label ID="NOMBRE_TECNICO_CARRERA" runat="server" Text='<%# Bind("NOMBRE_TECNICO_CARRERA") %>' required></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_nombre" Text='<%# Bind("NOMBRE_TECNICO_CARRERA") %>' runat="server" CssClass="form-control"></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="CODIGO">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txt_codigo" Text='<%# Bind("COD_CARRERA") %>' runat="server" CssClass="form-control" required></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerDetalle" TypeName="SysAcademico.App_Code.AdminCarrera" DeleteMethod="EliminarCarrera" OnDeleting="ObjectDataSource1_Deleting" OnUpdating="ObjectDataSource1_Updating" UpdateMethod="ActualizarCarreara">
                                <DeleteParameters>
                                    <asp:Parameter Name="ID_CARRERA" Type="String" />
                                </DeleteParameters>
                                <SelectParameters>
                                    <asp:SessionParameter DefaultValue="1" Name="ID_CARRERA" SessionField="ID_CARRERA" Type="String" />
                                </SelectParameters>
                                <UpdateParameters>
                                    <asp:Parameter Name="ID_CARRERA" Type="String" />
                                    <asp:Parameter Name="DESCRIPCION_CARRERA" Type="String" />
                                    <asp:Parameter Name="NOMBRE_TECNICO_CARRERA" Type="String" />
                                    <asp:Parameter Name="COD_CARRERA" Type="String" />
                                </UpdateParameters>
                            </asp:ObjectDataSource>

                            <asp:HiddenField Value="" runat="server" ID="hd_factura" />
