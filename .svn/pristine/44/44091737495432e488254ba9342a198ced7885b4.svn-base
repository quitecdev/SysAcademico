...
namespace CAS_ADMIN.Models
{
    public class Ejemplo
    {
        ...
        static Font titleFontBlue = FontFactory.GetFont("Arial", 14, Font.NORMAL, Color.BLUE);
        ...
        static Font EmailFont = FontFactory.GetFont("Arial", 8, Font.NORMAL, Color.BLUE);
        ...
        public void GenerateInvoice(string TransactionID)
        {
            ...
            iTextSharp.text.Image logo = iTextSharp.text.Image.GetInstance(HttpContext.Current.Server.MapPath("~/images/logo.png"));
...

            {
                ...
                nextPostCell1.Border = Rectangle.NO_BORDER;
                nested.AddCell(nextPostCell1);
                PdfPCell nextPostCell2 = new PdfPCell(new Phrase("Shivam Srivastava", titleFont));
                nextPostCell2.Border = Rectangle.NO_BORDER;
                nested.AddCell(nextPostCell2);
