<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteNotasEstudiante.aspx.cs" Inherits="SysAcademico.ReporteNotasEstudiante" %>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_periodo"  required></asp:DropDownList>
                                    </div>
                                </div>

                            </div>
                            <asp:Button ID="btn_buscar" Text="Exportar Notas" CssClass="btn btn-custom  w-md m-b-5" runat="server" OnClick="btn_buscar_Click" />
                            <div class="m-t-25"></div>
