<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReporteCronograma.aspx.cs" Inherits="SysAcademico.ReporteCronograma" %>
...
<body onload="pageLoad();">
    <form id="form1" runat="server">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title">REPORTE CRONOGRAMA</h4>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" class="form-control" ID="cmb_cronograma" required></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <asp:Button ID="btnReport" runat="server" CssClass="btn btn-custom" Text="Exportar Cronograma" OnClick="btnReport_Click"   />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
