<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDocenteMateria.aspx.cs" Inherits="SysAcademico.AdminDocenteMateria" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_carrera" required AutoPostBack="true" OnSelectedIndexChanged="cmb_carrera_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Materia:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_materia" required AutoPostBack="true" OnSelectedIndexChanged="cmb_materia_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Paralelo:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_paralelo" required AutoPostBack="true" OnSelectedIndexChanged="cmb_paralelo_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Horario:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_horario" required AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Docente:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_docenteAñadir" required AutoPostBack="true"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Docente:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_docenteEditar" AutoPostBack="True" OnSelectedIndexChanged="cmb_docenteEditar_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Materia:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cbm_materiaEditar" AutoPostBack="True" OnSelectedIndexChanged="cbm_materiaEditar_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="m-t-25"></div>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerMateriaHorario" TypeName="SysAcademico.App_Code.AdminDocenteMaterias" OnDeleting="ObjectDataSource1_Deleting" DeleteMethod="EliminarHorario">
                                    <DeleteParameters>
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="cmb_docenteEditar" DefaultValue="0" Name="ID_DOCENTE" PropertyName="SelectedValue" Type="String" />
                                        <asp:ControlParameter ControlID="cbm_materiaEditar" DefaultValue="0" Name="ID_MATERIA" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                            ...
                            <ContentTemplate>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Sede:</label>
                                            <asp:DropDownList runat="server" class="form-control" ID="cmb_sedeIntensivo" AutoPostBack="True" OnSelectedIndexChanged="cmb_sedeIntensivo_SelectedIndexChanged"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="m-t-25"></div>
                                <asp:GridView ID="Grid_Intensivos" GridLines="None" CssClass="gvv m-0 table table-striped dt-responsive nowrap dataTable no-footer dtr-inline" AutoGenerateColumns="False" runat="server" ShowHeaderWhenEmpty="True" DataSourceID="ObjectDataSource2" OnRowDeleting="Grid_Intensivos_RowDeleting" >
                                    <Columns>
                                        <asp:TemplateField HeaderText="#">
                                            <ItemTemplate>
                                                <asp:Label ID="ID_HORARIO_DETALLE" runat="server" Text='<%# Bind("ID_HORARIO_DETALLE") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="CARRERA">
                                            <ItemTemplate>
                                                <asp:Label ID="COD_CARRERA" runat="server" Text='<%# Bind("COD_CARRERA") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="MATERIA">
                                            <ItemTemplate>
                                ...
                                <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ObtenerHorarioIntensivo" TypeName="SysAcademico.App_Code.AdminDocenteMaterias" DeleteMethod="EliminarHorarioIntensivo" OnDeleting="ObjectDataSource2_Deleting">
                                    <DeleteParameters>
                                        <asp:Parameter Name="ID_HORARIO_DETALLE" Type="String" />
                                        <asp:Parameter Name="ID_DOCENTE" Type="String" />
                                        <asp:Parameter Name="ID_MATERIA" Type="String" />
                                    ...
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="cmb_sedeIntensivo" DefaultValue="0" Name="ID_SEDE" PropertyName="SelectedValue" Type="String" />
                                    </SelectParameters>
                                </asp:ObjectDataSource>
