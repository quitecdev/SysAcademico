            ...
            try
            {
                using (var ctx = new CAS_DataEntities())
                {
                    if (inscripcionDetalle.ID_INSCRIP_DETALLE_CARRERA == 0)
                    {
                        ...
                        _inscripcion.ID_PERIODO = inscripcionDetalle.ID_PERIODO;
        ...
        public void ActualizarDetalle(InscripcionDetalle inscripcionDetalle)
        {
            ...
            try
            {
                using (var ctx= new CAS_DataEntities())
                {
                    ...
                    else if (inscripcionDetalle.ID_TIPO_PAGO==5)
                    {
                        _detalleInscripcion.ID_ESTATUS = 5;
                    }
                    else
                    {
                    ...
                    _detalleInscripcion.ID_PERIODO = inscripcionDetalle.ID_PERIODO;
                    ...
                    {
                        if (inscripcionDetalle.ID_TIPO_PAGO != 5)
                        {
                        ...
                        else
                        {
                            _detalleEstudiante.ID_SEDE = inscripcionDetalle.ID_SEDE;
                            _detalleEstudiante.ID_CARRERA = inscripcionDetalle.ID_CARRERA;
                            _detalleEstudiante.ID_INTERVALO = 0;
                            _detalleEstudiante.ID_INTERVALO_DETALLE = 0;
                            _detalleEstudiante.ID_PARALELO = 0;
                            ctx.Entry(_detalleEstudiante).State = EntityState.Modified;
                        }
                    }
                    #endregion
