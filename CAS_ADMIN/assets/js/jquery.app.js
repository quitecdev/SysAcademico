...
function ModalForm(url) {
    $.get(url).done(function (responde) {
        ...
        $('.modal-form').html(responde);
        $('.modal-form').modal('show');
    });
}

function ModalFormRedirecto(url) {
    $('.modal-form').modal('toggle');
    $.get(url).done(function (responde) {
        $('.modal-redirect').modal('show');
        $('#modal-redirect-content').html(responde);
    });
}
...
function SubmitFormFile(form, url) {
    $(".btn-loding").button('loading');
    $.validator.unobtrusive.parse(form);
    if ($(form).valid()) {
        ...
        if ($(form).attr('encenctype') == 'multipart/form-data') {
